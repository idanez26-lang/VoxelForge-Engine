...
class AddVoxelCommand final : public EditorCommand
{
public:
    AddVoxelCommand(
        ...
        std::uint32_t y,
        std::uint32_t z,
        std::size_t colorIndex) noexcept;
    ...
    [[nodiscard]] const Voxel::Voxel& AddedVoxel() const noexcept;
...
private:
    ...
    std::uint32_t y_ = 0U;
    std::uint32_t z_ = 0U;
    std::size_t colorIndex_ = 0U;
    Voxel::Voxel previousVoxel_{};
    Voxel::Voxel addedVoxel_{};
